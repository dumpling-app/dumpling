...
static int32_t _ioctl_fd_path_internal(int32_t fd, int32_t ioctl_num, int32_t num_args, char* path, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t *out_data, uint32_t out_data_size) {
...
static int32_t _ioctl_fd_handle_internal(int32_t fd, int32_t ioctl_num, int32_t num_args, int32_t handle, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t *out_data, uint32_t out_data_size) {
    uint8_t *iobuf   = allocIobuf();
    uint32_t *inbuf  = (uint32_t *) iobuf;
    uint32_t *outbuf = (uint32_t *) &iobuf[0x520];
...
// clang-format off
#define dispatch_ioctl_arg4_out(fd, ioctl_num, handle_or_path, arg1, arg2, arg3, out_data, out_data_size) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 4, handle_or_path, arg1, arg2, arg3, out_data, out_data_size)
#define dispatch_ioctl_arg3_out(fd, ioctl_num, handle_or_path, arg1, arg2, out_data, out_data_size) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 3, handle_or_path, arg1, arg2, 0, out_data, out_data_size)
#define dispatch_ioctl_arg2_out(fd, ioctl_num, handle_or_path, arg1, out_data, out_data_size) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 2, handle_or_path, arg1, 0, 0, out_data, out_data_size)
#define dispatch_ioctl_arg1_out(fd, ioctl_num, handle_or_path, out_data, out_data_size) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 1, handle_or_path, 0, 0, 0, out_data, out_data_size)

#define dispatch_ioctl_arg4(fd, ioctl_num, handle_or_path, arg1, arg2, arg3) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 4, handle_or_path, arg1, arg2, arg3, 0, 0)
#define dispatch_ioctl_arg3(fd, ioctl_num, handle_or_path, arg1, arg2) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 3, handle_or_path, arg1, arg2, 0, 0, 0)
#define dispatch_ioctl_arg2(fd, ioctl_num, handle_or_path, arg1) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 2, handle_or_path, arg1, 0, 0, 0, 0)
#define dispatch_ioctl_arg1(fd, ioctl_num, handle_or_path) _Generic((handle_or_path), char*: _ioctl_fd_path_internal, int32_t: _ioctl_fd_handle_internal)(fd, ioctl_num, 1, handle_or_path, 0, 0, 0, 0, 0)
...
int32_t FSA_AppendFileEx(int32_t fd, uint32_t size, uint32_t cnt, int32_t fileHandle, uint32_t flags) {
    ...
    int32_t ret = svcIoctl(fd, 0x19, inbuf, 0x520, outbuf, 0x293);
...
int32_t FSA_ChangeOwner(int32_t fd, char *path, uint32_t owner, uint32_t group) {
	...
	int32_t ret = svcIoctl(fd, 0x70, inbuf, 0x520, outbuf, 0x293);
