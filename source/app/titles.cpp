...
bool isSystemApp(MCPAppType type) {
    return type == MCP_APP_TYPE_BROWSER || type == MCP_APP_TYPE_ESHOP || type == MCP_APP_TYPE_FRIEND_LIST || type == MCP_APP_TYPE_AMIIBO_SETTINGS || type == MCP_APP_TYPE_DOWNLOAD_MANAGEMENT || type == MCP_APP_TYPE_HOME_MENU || type == MCP_APP_TYPE_SYSTEM_MENU || type == MCP_APP_TYPE_EMANUAL || type == MCP_APP_TYPE_SYSTEM_APPS || type == MCP_APP_TYPE_SYSTEM_SETTINGS;
}
